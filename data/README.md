...
|---|---|---|---|---|---|
| XLSR-Mamba | [XLSR-Mamba (Xiao & Das, IEEE SPL 2025; arXiv:2411.10027)](https://github.com/swagshaw/XLSR-Mamba) | `Scores/DF/Bmamba3_LA_WCE_1e-06_ES144_NE12.txt` | `0698327cafdadec1` | 19,572,585 | 611,829 |
...
| XLSR-Conformer | [XLSR-Conformer (Rosello et al., Interspeech 2023)](https://github.com/ErosRos/conformer-based-classifier-for-anti-spoofing) | `Scores/DF/Scores_Best_DF_Fixed_size_train.txt` | `fd00e8ddb2838a9a` | 19,590,147 | 611,829 |
